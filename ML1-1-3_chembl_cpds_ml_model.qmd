...
**?try linking steps in a transformer/pipeline**
- polars will work with transformer in sklearn (https://scikit-learn.org/stable/auto_examples/release_highlights/plot_release_highlights_1_4_0.html#polars-output-in-set-output)
