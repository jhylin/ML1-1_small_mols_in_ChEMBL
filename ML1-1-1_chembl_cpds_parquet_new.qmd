...
2. Polars seems to be a bit more integrated with scikit_learn now so I'm wondering if Polars dataframe library can be used with scikit_learn solely (i.e. not using Pandas at all)
