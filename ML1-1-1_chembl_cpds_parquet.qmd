...
: File size changes without data partitions {#tbl-first}

+-------------------+-----------------------------------+--------------+--------------------+
| Compression level | Data restrictions                 | File size    | Number of entries  |
+===================+===================================+==============+====================+
| default           | None                              | to add       | ~2 million         | 
+-------------------+-----------------------------------+--------------+--------------------+
| to add            | - to be entered                   | to add       | to add             |
+-------------------+-----------------------------------+--------------+--------------------+
| to add            | - to be entered                   | to add       | to add             |
|                   | - to be entered                   |              |                    |
+-------------------+-----------------------------------+--------------+--------------------+
...
: File size changes with data partitions {#tbl-second}

Tables of parquet file size changes
:::
