...
Adding one more data restriction step

```{python}
# Both "Name" and "Synonyms" columns are compound names - keeping only one for now in order to reduce data size
# drop "Synonyms" column as not going to need it
...
* file size after using the "null_values" - 103.7MB (hmm...)
