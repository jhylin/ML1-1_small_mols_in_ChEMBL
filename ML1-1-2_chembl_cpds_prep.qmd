...
- LR may not be the best choice of ML model to start off with (but I just want to find out how it works at the time and because I'm updating the post now so I'm trying to keep it the same...)
