...
**QED Weighted** - Weighted quantitative estimate of drug likeness (***cite*** as defined by Bickerton *et al.*, Nature Chem 2012)
...
From the `glimpse()` method previously, there are a lot of columns with the data type of "str". There are only two columns having "i64", meaning they are integers. A lot of these columns are actually storing numbers as strings. So to make my life easier, I'm going to convert these strings into either integers or floats.

**The following needs to be updated**

*?is the casting code still the same as below or there's another/better way to do it*
...
# works only if "None" is of i64 or f64 etc.

# df_pa.fill_null(strategy="zero")
# df_pa
```
...
# Significantly reduce the entries from 1,901,819 to 635,776 if dropping nulls with columns of string type
...
df_pa.cast(
  {"Molecular Weight": pl.Float64, 
  "Targets": pl.Int64,
  "Bioactivities": pl.Int64,
  "AlogP": pl.Float64,
  # Need to take care of "None" values
  # "Polar Surface Area": pl.Float64,
  # "HBA": pl.Int64,
  # "HBD": pl.Int64,
  # "#RO5 Violations": pl.Int64,
  # "#Rotatable Bonds": pl.Int64, 
  # "QED Weighted": pl.Float64,
  # "CX Acidic pKa": pl.Float64,
  # "CX Basic pKa": pl.Float64,
  # "CX LogP": pl.Float64,
  # "CX LogD": pl.Float64,
  # "Aromatic Rings": pl.Int64, 
  # "Heavy Atoms": pl.Int64,
  # "HBA (Lipinski)": pl.Int64,
  # "HBD (Lipinski)": pl.Int64,
  # "#RO5 Violations (Lipinski)": pl.Int64, 
  # "Molecular Weight (Monoisotopic)": pl.Float64
  }
  #strict=False
)
